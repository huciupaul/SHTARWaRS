...
def calc_cost(P_FC, P_eps, m_sto, m_fc, m_h2):
    ...
    print(f"Initial costs: FC={fc_init}, STO={sto_init}, EPS={eps_init}, AC={AC_purchase_cost}, Dev={AC_dev_cost}, Total={purchase_cost}")
    ...
    print(f"Operational costs per year: FC={fc_maint}, STO={sto_maint}, Landing={landing}, Crew={crew}, Fuel={fuel_cost}, Insurance={insurance}, Total={operational_costs}")
    ...
    print(f"Disposal costs: FC={fc_disposal}, STO={sto_disposal}, Total={disposal_cost}")
    ...
    # -----Total cost-----
    total_cost = purchase_cost + operational_costs * years_of_life + disposal_cost + depreciation
...
print(calc_cost(500, 500*.99*.97, 275, 100, 250))