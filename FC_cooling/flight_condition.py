...
class FlightCondition:
    def __init__(self, name, T_amb, P_amb, RH_amb, V, actual_power_required, power_split, thermal_efficiency, propulsive_efficiency, P_cc, T_cc):
        self.name = name
        ...
        self.actual_power_required = actual_power_required  # Power required in W
        self.power_split = power_split   # Proportion of power outputted from the fuel cell
        self.thermal_efficiency = thermal_efficiency # TODO: add array of values based on flight condition
        self.propulsive_efficiency = propulsive_efficiency
        self.power_required = actual_power_required / propulsive_efficiency
        self.P_cc = P_cc
        self.T_cc = T_cc # Temperature of the hydrogen inputted into combustion chamber in K
